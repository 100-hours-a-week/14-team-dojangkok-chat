...
import com.dojangkok.chat.service.ChatReadStatusService;
...
public class ChatController {
    ...
    public void markAsRead(ReadStatusRequest request, Principal principal) {
        ...
        chatReadStatusService.markAsReadAndNotify(userId, request.getRoomId(), request.getLastReadMessageId());
    }
}
